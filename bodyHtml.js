...
function loadBody(){
    document.getElementById('body').innerHTML = document.getElementById('body').innerHTML + `
        ...
        <title>AB Notes</title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta name="Description" content="Lightweight, powerful, well designed PWA by Alex Besida">
    ...
    document.getElementById('AppNotifications').innerHTML =`
        <div id="ANS" class="ANCard">
            <svg class='ANIcon' id='ANSIcon' width="24" height="24" viewBox="0 0 24 24" style="fill:var(--main-color)" xmlns="http://www.w3.org/2000/svg">
